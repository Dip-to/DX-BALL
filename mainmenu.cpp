...
void option_render()
{
	while(option)
	{
		...
		if(mousesx>=back.x && mousesx<=(back.x+back.w) && mousesy>=back.y && mousesy<=(back.y+back.h))
		{
			...
			if(mousesx>=sound_on2.x && mousesx<=(sound_on2.x+sound_on2.w) && mousesy>=sound_on2.y && mousesy<=(sound_on2.y+sound_on2.h))
			{
				if(sound==0)
				{
					sound_on2.w=200;
				...
				if(buttonss & SDL_BUTTON(SDL_BUTTON_LEFT))
				{
			...
			else if(mousesx>=sound_off2.x && mousesx<=(sound_off2.x+sound_off2.w) && mousesy>=sound_off2.y && mousesy<=(sound_off2.y+sound_off2.h))
			{
				if(sound==1)
				{
					sound_off2.w=200;
			...
			if(mousesx>=gamesound_on2.x && mousesx<=(gamesound_on2.x+gamesound_on2.w) && mousesy>=gamesound_on2.y && mousesy<=(gamesound_on2.y+gamesound_on2.h))
			{
				if(gamesound==0)
				{
					gamesound_on2.w=200;
			...
			else if(mousesx>=gamesound_off2.x && mousesx<=(gamesound_off2.x+gamesound_off2.w) && mousesy>=gamesound_off2.y && mousesy<=(gamesound_off2.y+gamesound_off2.h))
			{
				if(gamesound==1)
				{
...
void help_render()
{
	while(Help)
	{
		...
		if(hmousex>=instruction.x && hmousex<=(instruction.x+instruction.w) && hmousey>=instruction.y && hmousey<=(instruction.y+instruction.h))
		{
		...
		if(hmousex>=controls.x && hmousex<=(controls.x+controls.w) && hmousey>=controls.y && hmousey<=(controls.y+controls.h))
		{
		...
		if(hmousex>=powerup_info.x && hmousex<=(powerup_info.x+powerup_info.w) && hmousey>=powerup_info.y && hmousey<=(powerup_info.y+powerup_info.h))
		{
